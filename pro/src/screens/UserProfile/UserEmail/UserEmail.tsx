...
import { getPendingEmailValidationAdapter } from 'oldpages/User/adapters/getPendingEmailValidationAdapter'
import postEmailAdapter from 'oldpages/User/adapters/postEmailAdapter'
